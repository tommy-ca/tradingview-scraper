...
## Phase 1: Robust Test Suite [checkpoint: 8bcc136]
...
## Phase 2: Gap Detection Logic [checkpoint: 8bcc136]
...
## Phase 3: Gap Filler Implementation [checkpoint: 8bcc136]
Goal: Automatically repair missing data segments where possible.

- [x] Task: Research if TradingView's `create_series` supports requesting specific historical offsets (Found to be limit-based, handled by depth calculation).
