...
* **Structural Additive Champion (v2.1):** Implementation of an HPO-tuned additive rank-sum model that identifies "all-rounder" assets. Demonstrated superior risk-adjusted performance (Sharpe 3.75) by balancing momentum, survival, and spectral predictability, providing a more stable and lower-volatility alternative to multiplicative models.
