...
* **Global Robust Selection:** Utilization of `optuna` to identify a single, "weather-proof" weight set for the Log-MPS 3.2 selection engine. Optimized for Risk-Adjusted Selection Alpha across multiple regimes, eliminating the complexity of dynamic switching while maintaining high-fidelity return capture.
