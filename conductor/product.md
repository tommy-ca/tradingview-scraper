...
* **Automated Selection Optimization:** Integration with `optuna` for regime-specific hyperparameter tuning of the Log-MPS 3.2 selection engine. Enables automated discovery of optimal alpha-generating weights for momentum, stability, and predictability metrics.
