...
* **Spectral Predictability Filtering:** Advanced asset-level pruning using Permutation Entropy, Hurst Exponent, and Kaufman's Efficiency Ratio. Mathematically filters out random noise and "chop" during Natural Selection to focus on high-fidelity, efficient trends.
