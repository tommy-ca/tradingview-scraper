...
## Acceptance Criteria
- [x] LSP errors resolved in `backtest/engine.py`.

## Work Log
- 2026-02-05: Identified during code review.
- 2026-02-05: Fixed return type mismatches, added missing casts for pandas objects, fixed tuple unpacking in regime detection, and added explicit return type for simulation method.
