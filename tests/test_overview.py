...
class TestOverview:
    ...
    def test_get_symbol_overview_success(self, mock_get, overview):
        ...
        mock_response.json.return_value = {"name": "AAPL", "description": "Apple Inc.", "close": 150.25, "market_cap_basic": 2500000000000, "change": 2.5}
    ...
    def test_get_symbol_overview_with_custom_fields(self, overview):
        ...
        result = overview.get_symbol_overview(symbol="NASDAQ:AAPL", fields=custom_fields)
