Binance Screening Presets
=========================

Overview
--------
- Base universe: Binance symbols excluding stable bases (USDT/USDC/BUSD/FDUSD/TUSD/DAI/PAX/USDP/EUR/GBP/BIDR/TRY/BRL/UST/USTC/CHF/JPY).
...
- Cross-Sectional Momentum (long) – ``binance_xs_momentum.yaml``
...
- Cross-Sectional Mean Reversion (long) – ``binance_xs_mean_reversion.yaml``
...
- TS Momentum (long) – ``binance_ts_momentum_long.yaml``
...
- TS Mean Reversion (long) – ``binance_ts_mean_reversion_long.yaml``
...
- TS Momentum (short) – ``binance_ts_momentum_short.yaml``
...
- TS Mean Reversion (short) – ``binance_ts_mean_reversion_short.yaml``
...
.. code-block:: bash
   ...
   python -m tradingview_scraper.futures_universe_selector --config configs/binance_trend_momentum.yaml --verbose
