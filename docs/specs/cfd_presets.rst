...
- Trend-following (screener-only prototype): see ``configs/cfd_trend_momentum.yaml``
...
.. code-block:: bash
   ...
   python -m tradingview_scraper.cfd_universe_selector --config configs/cfd_trend_momentum.yaml --verbose
