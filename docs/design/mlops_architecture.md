...
- **Infrastructure as Code**: `infra/ray-cluster.yaml` defines the head and worker nodes.
- **Spot Integration**: Automatically use spot instances for Ray worker nodes to minimize cloud costs.
